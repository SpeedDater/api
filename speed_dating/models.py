...
class Profile(models.Model):
    ...
    availability = models.ManyToManyField(config_models.SectionTime, blank=False)
    majors = models.ManyToManyField(config_models.Major, blank=False)
    interests = models.ManyToManyField(config_models.Skill, blank=False, related_name='interests')
    skills = models.ManyToManyField(config_models.Skill, blank=False, related_name='skills')
